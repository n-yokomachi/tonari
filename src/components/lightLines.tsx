...
export function LightLines({
  ...
  useEffect(() => {
    ...
    animationsRef.current = allLights.map((light) => {
      ...
      const duration =
        ((Math.floor(Math.random() * 59) + 2) * 0.5 + 0.5) / speedMultiplier
      return {
        element,
        from: light.from,
        to: light.to,
  ...
  return (
    <div
      ref={containerRef}
      className={`absolute inset-0 h-full w-full flex justify-center overflow-hidden pointer-events-none ${className ?? ''}`}
    >
      <svg
      ...
      >
        <g className="lines" style={{ opacity: linesOpacity }}>
          ...
          <rect
            ...
            style={{ fill: lineColor }}
          />
          <rect x="615" width="1" height="1080" style={{ fill: lineColor }} />
          <rect
            x="684.6"
            width="0.5"
            height="1080"
          ...
          <rect
            ...
            style={{ fill: lineColor }}
          />
          <rect x="70.3" width="1" height="1080" style={{ fill: lineColor }} />
          <rect
            x="1618.6"
            width="0.5"
            height="1080"
          ...
          <rect
            ...
            style={{ fill: lineColor }}
          />
          <rect x="300.8" width="1" height="1080" style={{ fill: lineColor }} />
          <rect
            x="1666.4"
            width="0.3"
            height="1080"
