...
- [x] 1. gmail-tool Lambda 実装
- [x] 1.1 OAuth2認証とメール検索機能の実装
...
- [x] 3. (P) チャットログ分割ロジック実装
- [x] 3.1 ツール呼び出し境界でのチャットバブル分割
...
- [x] 4.2 ブリーフィングモード手順・出力フォーマット指示の追加
