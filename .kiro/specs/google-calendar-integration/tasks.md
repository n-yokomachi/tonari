...
- [ ] 1. Google Cloud OAuth2認証のセットアップ
- [ ] 1.1 Google Cloud Consoleでのプロジェクト作成とOAuth2クライアント設定
...
- [ ] 2. calendar-tool Lambda関数の実装
- [ ] 2.1 認証基盤とイベント一覧取得ツールの実装
...
- [ ] 3. CDKインフラの構築
- [ ] 3.1 calendar-tool LambdaのCDK定義
...
- [ ] 4. エージェント統合
- [ ] 4.1 (P) システムプロンプトへのカレンダーツール説明の追加
