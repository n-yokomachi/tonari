...
- [ ] 1. Lambda関数の基盤構築（認証・ディスパッチ・ヘルパー）
...
- [ ] 3. CDKインフラストラクチャ統合
- [ ] 3.1 (P) WorkloadConstructにnotion-tool Lambda定義を追加
...
- [ ] 3.2 (P) AgentCoreConstructにGateway Target登録を追加
...
- [ ] 3.3 TonariStackにnotion-tool Lambdaのwiring追加
  - AgentCoreConstruct初期化時にWorkloadConstructのnotionToolLambdaを渡すwiringを追加する
  - _Requirements: 8.3_

- [ ] 4. (P) システムプロンプトへのNotion活用ガイダンス追加
